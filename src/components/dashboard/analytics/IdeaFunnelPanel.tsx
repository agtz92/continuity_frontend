...
export function IdeaFunnelPanel({ funnel }: { funnel: IdeaFunnel }) {
  ...
  return (
    <PanelCard
      title="Funnel de ideas"
      icon={<ArrowRightCircle size={16} className="text-pink-400" />}
      subtitle="Ideas creadas vs promovidas a proyecto"
    >
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-zinc-950/50 border border-zinc-800 rounded-lg p-3">
          ...
          <div className="text-xs text-zinc-500 mt-1">Creadas</div>
        </div>
        <div className="bg-zinc-950/50 border border-zinc-800 rounded-lg p-3">
          <div className="text-2xl font-semibold text-emerald-300">
            {funnel.ideasPromoted}
          </div>
          <div className="text-xs text-zinc-500 mt-1">Promovidas</div>
        </div>
        <div className="bg-zinc-950/50 border border-zinc-800 rounded-lg p-3">
          <div className="text-2xl font-semibold text-zinc-100">
            {pct}
          ...
          <div className="text-xs text-zinc-500 mt-1">Tasa</div>
        </div>
      </div>
    </PanelCard>
  );
